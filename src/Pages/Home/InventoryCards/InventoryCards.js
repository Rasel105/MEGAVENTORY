...
const InventoryCards = () => {
    ...
    return (
        <div className='container w-full mx-auto '>
            <h3 className='text-center text-3xl my-4 text-gray-700'>Top <span className='text-green-400'>Sale</span> Products</h3>
            ...
            <div className='flex justify-end m-5 sm:m-5'>
                <Link to='/manageInventories' className=' inline-flex items-center justify-center bg-teal-400 py-3 px-3 rounded-md text-white text-xl'>
                    Manage Inventories
